...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/10 17:50:32 by ynenakho          #+#    #+#             */
/*   Updated: 2018/02/02 01:47:19 by ynenakho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static t_list		*find(t_list **store, int fd)
{
	t_list		*temp;
...
static char			*linestore(char *content, char **line)
{
	int		i;
	char	*temp;
